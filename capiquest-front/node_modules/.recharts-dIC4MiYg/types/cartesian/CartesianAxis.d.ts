...
import { CartesianViewBox, PresentationAttributesAdaptChildEvent, CartesianTickItem, AxisInterval, TickProp } from 'recharts/types/util/types';
import { AxisId, XAxisOrientation, XAxisPadding, YAxisOrientation, YAxisPadding } from 'recharts/types/state/cartesianAxisSlice';
