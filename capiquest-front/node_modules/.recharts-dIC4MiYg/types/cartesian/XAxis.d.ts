...
import { AxisInterval, AxisTick, RenderableAxisProps, PresentationAttributesAdaptChildEvent, AxisDomain, ScaleType, AxisDomainTypeInput, EvaluatedAxisDomainType, TickProp, XAxisTickContentProps, TickItem } from 'recharts/types/util/types';
import { XAxisOrientation, XAxisPadding, NiceTicksAlgorithm } from 'recharts/types/state/cartesianAxisSlice';
