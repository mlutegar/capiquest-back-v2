...
import { AxisDomainTypeInput, AxisInterval, AxisTick, RenderableAxisProps, PresentationAttributesAdaptChildEvent, AxisDomain, ScaleType, EvaluatedAxisDomainType, TickProp, YAxisTickContentProps, TickItem } from 'recharts/types/util/types';
import { YAxisOrientation, YAxisPadding, YAxisWidth, NiceTicksAlgorithm } from 'recharts/types/state/cartesianAxisSlice';
...
export declare const yAxisDefaultProps: {
    ...
    readonly scale: ScaleType | CustomScaleDefinition<import("recharts/types/util/types").CategoricalDomainItem> | CustomScaleDefinition<string> | CustomScaleDefinition<number> | CustomScaleDefinition<Date>;
