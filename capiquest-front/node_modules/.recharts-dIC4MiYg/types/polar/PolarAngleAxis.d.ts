...
import { AxisDomain, AxisDomainTypeInput, BaseTickContentProps, PresentationAttributesAdaptChildEvent, RenderableAxisProps, ScaleType, TickItem, TickProp } from 'recharts/types/util/types';
import { NiceTicksAlgorithm } from 'recharts/types/state/cartesianAxisSlice';
