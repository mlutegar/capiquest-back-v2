...
import { RadialBarSectorProps } from 'recharts/types/util/RadialBarUtils';
...
import { ActiveShape, AnimationDuration, AnimationTiming, DataConsumer, DataKey, LayoutType, LegendType, PolarViewBoxRequired, PresentationAttributesAdaptChildEvent, TickItem, TooltipType } from 'recharts/types/util/types';
import { TooltipTriggerInfo } from 'recharts/types/context/tooltipContext';
