import { AxisDomain, CartesianTickItem, CategoricalDomain, Coordinate, RechartsScaleType, DataKey, LayoutType, NumberDomain, Size, StackOffsetType, TickItem } from 'recharts/types/util/types';
...
import { RechartsScale } from 'recharts/types/util/scale/RechartsScale';
import { InverseScaleFunction } from 'recharts/types/hooks';
